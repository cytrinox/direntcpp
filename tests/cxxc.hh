...
#define DEFINE_HAS_MEM(func)                                            \
	...
	virtual ~Test(void) {}
        ...
        const char* name(void) const { return this->m_name.c_str(); }

        const char* file(void) const { return this->m_file.c_str(); }
...
/// CXXC_MAIN_ENTRY Macro
///
/// Adds a main() function to the test program.
/// This is the recommended way to run test.
#define CXXC_MAIN_ENTRY                         \
    int main(void)                              \
    {                                           \
